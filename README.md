...
------------ | ------------- | ------------- | -------------
*ExecuteApi* | [**deleteProxy**](docs/Api/ExecuteApi.md#deleteproxy) | **DELETE** /proxy | DELETE
*ExecuteApi* | [**getProxy**](docs/Api/ExecuteApi.md#getproxy) | **GET** /proxy | GET
*ExecuteApi* | [**optionsProxy**](docs/Api/ExecuteApi.md#optionsproxy) | **OPTIONS** /proxy | OPTIONS
*ExecuteApi* | [**patchProxy**](docs/Api/ExecuteApi.md#patchproxy) | **PATCH** /proxy | PATCH
*ExecuteApi* | [**postProxy**](docs/Api/ExecuteApi.md#postproxy) | **POST** /proxy | POST
*ExecuteApi* | [**putProxy**](docs/Api/ExecuteApi.md#putproxy) | **PUT** /proxy | PUT

## Models

- [GetProxy401Response](docs/Model/GetProxy401Response.md)
- [PostProxyRequest](docs/Model/PostProxyRequest.md)
- [PutProxyRequest](docs/Model/PutProxyRequest.md)
